    ...
    return (
      ...
      >
        <AccordionTrigger className="px-3 py-2 text-sm hover:no-underline">
          {
            // `tool.description` can be a string or a function that returns a string.
            // Call it safely when it's a function, otherwise render the string.
            typeof tool.description === "function"
              ? tool.description({ context: {} as any })
